		...
		<a class="nav" href="#">订单管理</a>
				...
				<aside class="content_side_bar">
					...
					<ul class="channels" id="channels">
						<li><i class="icon-edit"></i><a href="enterprisecenterui">企业信息</a></li>
				...
				<div class="content_edit_box" id="content_edit_box">
					...
					<tbody>
						<c:forEach items="${pas}" var="pas">
						<tr>
							<td>${pas.pt_name}</td>
							<td>${pas.pt_starttime}</td>
							<td>${pas.pt_stoptime}</td>
							<td>${pas.pt_review}</td>
							<td><a href="editpartui?pt_id=${pas.pt_id}">查看/修改</a></td>
