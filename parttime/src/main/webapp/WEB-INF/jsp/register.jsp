		...
		<section class="container">
			<header class="w_main">
				<div class="logo_box clearfix">
					...
					<div class="title_wrap left">用户注册</div>
				</div>
			</header>
			...
			<div class="w_main content_box clearfix">
				<div class="login_box">
					<div class="user_type_tabs clearfix" id="user_type_tabs">
						<span class="selected" id="user_type-0">个人用户</span> <span  id="user_type-1">企业用户</span>
					</div>
					...
					<div class="info_box" id="info_box1">
						...
						<input type="text" class="loginregister"  name="p_name">
						</label>
						<div class="forget_psw_wrap">
							设置密码
						</div>
						<label class="psw_wrap"><i class="icon-lock"></i> 
						<input type="password" class="loginregister" name="p_password"></label>
						
						
						
						
						<div class="login_btn" id="login_btn" >
							<button class="personloginsubmit" type="submit">注册兼兼</button> 
						</div>
					...
					<div class="info_box" id="info_box2" style="display: none;">
						<div>设置企业用户登录名</div>
						<label class="account_wrap"><i class="icon-user"></i> 
						<input type="text" class="loginregister"  name="e_name" tabindex="1">
						</label>
						<div class="forget_psw_wrap">
							设置密码
						...
						<label class="psw_wrap"><i class="icon-lock"></i> 
						<input type="password" class="loginregister"  name="e_password" tabindex="2"></label>
