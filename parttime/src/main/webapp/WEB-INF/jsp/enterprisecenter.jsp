		...
		<a class="nav" href="#">订单管理</a>
				...
				<div class="content_edit_box" id="content_edit_box">
					<div class="box" id="resume_box" style="display: block;">
						<div class="hd">
							公司资料
							<a class="btn right cancel show_when_edit" style="display: inline;" href="enterpriseeditui">修改企业信息</a>
						</div>
						<div class="cnt">
							<form id="resume_form">
								<div class="row">
									...
									<div class="show_when_edit" style="display: block;">
										<label>
										<span>${enterprise.e_fullname}</span>
										</label>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="show_when_edit" style="display: block;">
										<label>
										<span>${enterprise.e_linkman}</span>
										</label>
									</div>
								</div>

								<div class="row">
									<span class="txt_left">联系邮箱:</span>
									<div class="show_when_edit" style="display: block;">
										<label>
										<span>${enterprise.e_email}</span>
										</label>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="show_when_edit" style="display: block;">
										<label>
										<span>${enterprise.e_address}</span>
										</label>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="show_when_edit" style="display: block;">
										<label>
										<span>${enterprise.e_registration}</span>
										</label>
									</div>
								</div>
								
								
								<!-- <a href="enterpriseeditui">修改公司信息</a> -->
