			...
			<div class="w_main content_box clearfix">
				<div class="login_box">
					...
					<div class="info_box" id="info_box1">
						...
						<input type="text" class="loginregister"  name="p_name" tabindex="1">
						</label>
						...
						<input type="password" class="loginregister"  name="p_password" tabindex="2"></label>

						<div class="login_btn" id="login_btn" >
							<button class="personloginsubmit" type="submit">登录兼兼</button> 
						</div>
